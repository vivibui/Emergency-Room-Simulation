...
2. Check dataset names in 
    ...
    (b) CREATE_COPY
    (c) MERGE 
3. In EXPORT_FILES, created an empty "Processed" folder in the designated path 
...
# Run function 
df_er_c1 <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/3A/C1/EmergencyRoom")
df_er_c2 <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/3A/C2/EmergencyRoom")
df_er_fifo <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/3A/FIFO/EmergencyRoom")
df_er_a1pp <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/3A/A1-PP/EmergencyRoom")
df_er_a2pq <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/3A/A2-PQ/EmergencyRoom")
df_er_z1pq <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/3A/Z1-PQ/EmergencyRoom")
df_er_z2pq <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/3A/Z2-PQ/EmergencyRoom")
df_er_z3q <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/3A/Z3-Q/EmergencyRoom")


df_p_c1 <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/3A/C1/PatientList")
df_p_c2 <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/3A/C2/PatientList")
df_p_fifo <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/3A/FIFO/PatientList") 
df_p_a1pp <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/3A/A1-PP/PatientList")
df_p_a2pq <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/3A/A2-PQ/PatientList")
df_p_z1pq <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/3A/Z1-PQ/PatientList")
df_p_z2pq <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/3A/Z2-PQ/PatientList")
df_p_z3q <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/3A/Z3-Q/PatientList")

df_sf_c1 <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/3A/C1/Satisfaction")
df_sf_c2 <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/3A/C2/Satisfaction")
df_sf_fifo <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/3A/FIFO/Satisfaction")
df_sf_a1pp <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/3A/A1-PP/Satisfaction")
df_sf_a2pq <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/3A/A2-PQ/Satisfaction")
df_sf_z1pq <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/3A/Z1-PQ/Satisfaction")
df_sf_z2pq <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/3A/Z2-PQ/Satisfaction")
df_sf_z3q <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/3A/Z3-Q/Satisfaction")
```
...
# Create Function 
main_path = "~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/3A/Processed"
...
# Merge
df_er <- list(df_er_c1_copy, df_er_c2_copy, df_er_fifo_copy,
            df_er_a1pp_copy, df_er_a2pq_copy, df_er_z1pq_copy,
            df_er_z2pq_copy, df_er_z3q_copy)

df_p <- list(df_er_c1_copy, df_er_c2_copy, df_er_fifo_copy,
            df_er_a1pp_copy, df_er_a2pq_copy, df_er_z1pq_copy,
            df_er_z2pq_copy, df_er_z3q_copy)

df_er <- df_er %>% reduce(full_join, by=c("Sim_N", "Day", "Time", "New_Patients", "Waiting", "Assigned", "Discharged", "Beds_Avail_EOH", "Method"))

df_p <- df_p %>% reduce(full_join, by=c("Sim_N", "Day", "Time", "New_Patients", "Waiting", "Assigned", "Discharged", "Beds_Avail_EOH", "Method"))
