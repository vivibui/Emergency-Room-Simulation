...
# Run function 
df_er_c1 <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/2B/C1/EmergencyRoom")
df_er_c2 <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/2B/C2/EmergencyRoom")
df_er_fifo <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/2B/FIFO/EmergencyRoom")

df_p_c1 <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/2B/C1/PatientList")
df_p_c2 <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/2B/C2/PatientList")
df_p_fifo <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/2B/FIFO/PatientList") 

df_sf_c1 <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/2B/C1/Satisfaction")
df_sf_c2 <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/2B/C2/Satisfaction")
df_sf_fifo <- create_file("~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/2B/FIFO/Satisfaction")
...
# Create Function 
main_path = "~/Desktop/Emergency-Room-Simulation/Patient_Only/Output/2B/Processed"
